...
{
    class Mushroom : IItem, IDraw, IUpdate, IMovable, ICollidable
    {
        ...
        public Mushroom(String itemName, Vector2 position) // Should I just use the gameobject manager? Items will probably include mushroom, star, coin
        {
