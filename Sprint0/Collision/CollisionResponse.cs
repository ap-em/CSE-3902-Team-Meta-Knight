...
namespace Sprint0
{
    ...
    public class CollisionResponse
    {
        ...
        public void CollisionOccurrence(IGameObject collider, IGameObject collided, String direction, Rectangle rectangle)
        {
            ...
            {
                commandName1 = MoverResponse[collider.ToString() + collided.ToString() + direction];
            ...
            {
                commandName1 = MoverResponse[collider.ToString() + collided.ToString()];
            ...
            {
                commandName2 = TargetResponse[collided.ToString() + collider.ToString() + direction];
            ...
            {
                commandName2 = TargetResponse[collided.ToString() + collider.ToString()];
                Type t2 = Type.GetType(commandName2);
                Type[] types2 = { Type.GetType(collided.ToString()), Type.GetType(collider.ToString()), typeof(Rectangle) };
                object[] param2 = { collided, collider, rectangle };
