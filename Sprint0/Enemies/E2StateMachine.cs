...
namespace Sprint0.Enemies
{
    class E2StateMachine : IEnemyStateMachine
    {
        ...
        {
            this.enemy = enemy;
            enemy.sprite = SpriteFactory.Instance.CreateE2IdleLeft();
        ...
        */
        ...
        {
            enemy.stateMachine = new E1StateMachine(enemy);
        }
        ...
        public void FireProjectile()
        {
            ...
            {
                //enemy.sprite = SpriteFactory.Instance.CreateE2ShootRight();
            }
            else if (facingUp)
            {
                //enemy.sprite = SpriteFactory.Instance.CreateE2ShootUp();
            }
            else if (facingDown)
            {
                //enemy.sprite = SpriteFactory.Instance.CreateE2ShootDown();
            }
            */
        }
